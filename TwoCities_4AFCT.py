...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\hcccl\\Documents\\Hippopolis\\TwoCities_4AFCT.py',
...
test_trials = './stimuli/subj_files/' + ID + '_4afct_test.csv'
...
for thisTrials_4afct in trials_4afct:
    ...
    # keep track of which components have finished
    test_trial_4afctComponents = [street_text_updating, test_image1, test_image2, test_image3, test_image4, button_d, button_f, button_j, button_k, key_resp_4afct, clock0]
    ...
    trials_4afct.addData('key_resp_4afct.keys',key_resp_4afct.keys)
    if key_resp_4afct.keys != None:  # we had a response
        trials_4afct.addData('key_resp_4afct.rt', key_resp_4afct.rt)

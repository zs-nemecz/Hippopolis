...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Zsuzsa\\HCCCL\\Prediction-and-Memory\\Hippopolis\\TwoCities_LearningPhase_lastrun.py',
...
# --- Initialize components for Routine "city_intro" ---
...
for thisCityBlock in CityBlock:
    ...
    # --- Prepare to start Routine "city_intro" ---
    continueRoutine = True
    routineForceEnded = False
    # update component parameters for each repeat
    ...
    # keep track of which components have finished
    intro_videoComponents = [movie, end_vid_key]
    ...
    for thisTrial in trials:
        ...
        # keep track of which components have finished
        written_testComponents = [plate_verbal, street_text_verbal, city_text_verbal, question_verbal, text_response_test, mouse]

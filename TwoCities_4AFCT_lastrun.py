...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\hcccl\\Documents\\Hippopolis\\TwoCities_4AFCT_lastrun.py',
...
# Run 'Begin Experiment' code from count_responses
target = 0
lure = 0
dist1 = 0
dist2 = 0
...
for thisCityBlock in CityBlock:
    ...
    # Run 'Begin Routine' code from count_responses
    target = 0
    lure = 0
    dist1 = 0
    dist2 = 0

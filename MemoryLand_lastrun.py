...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Zsuzsa\\HCCCL\\Prediction-and-Memory\\Hippopolis\\MemoryLand_lastrun.py',
...
for thisCityBlockLearning in CityBlockLearning:
    ...
    for thisLearningTrial in LearningTrials:
        ...
        routineForceEnded = False
        # update component parameters for each repeat
        # Run 'Begin Routine' code from save_phase
...
# Run 'Begin Routine' code from set_4afct_phase
phase = 'FinalTest'
# keep track of which components have finished
